...
from Classes.factory import RpgObjectFactory
...
def criarItem():
    ...
    tipo = input("Tipo: ")
    item = RpgObjectFactory.criarItem(nome, peso, preco, descricao, raridade, tipo)
    itens.append(item)
...
def criarArma():
    ...
    arma = RpgObjectFactory.criarArma(itemSelecionado, dano, durabilidade, nivel)
    armas.append(arma)
...
def criarClasse():
    ...
    classe = RpgObjectFactory.criarClasse(nome, armaUnica, descricao)
...
def criarRaca():
    ...
    raca = RpgObjectFactory.criarRaca(atributoUnico, nome, debuff, descricao,
...
def criarPersonagem():
    ...
    personagem = RpgObjectFactory.criarPersonagem(nome, altura, sexo, nivel, idade, classeSel, racaSel, inventario)
